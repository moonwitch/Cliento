...
export async function TreatmentsPage() {
  ...
  try {
    ...
    // Als cmsReq undefined is, maak er een leeg object van {}
    const content = cmsReq || {};

    // Als treatmentsReq.data NULL is, maak er een lege lijst van []
    ...
    // 2. Groeperen (Nu veilig omdat 'treatments' altijd een array is)
    const grouped = {};
